...
public class AESDecrypt implements IPredefinedProcFunc {
	...
	public void execute(IVm interpreter) throws FFaplAlgebraicException {
		...
		case IJavaType.INTEGER:
			input = Algorithm.AESDecrypt((BInteger)c, (BInteger)k, true, (BInteger)iv);
	...
	public static void registerProcFunc(ISymbolTable symbolTable)
		...
		s = new FFaplPreProcFuncSymbol("AESDecrypt", 
                null,
                new FFaplInteger(),
                ISymbol.FUNCTION);
		s.setProcFunc(new AESDecrypt());
