...
public class AESEncrypt implements IPredefinedProcFunc {

	@Override
	public void execute(IVm interpreter) throws FFaplAlgebraicException {
		// TODO Auto-generated method stub
		IJavaType iv = (IJavaType) interpreter.popStack();
...
//			break;
		case IJavaType.INTEGER:
			input = Algorithm.AESEncrypt((BInteger)m, (BInteger)k, true, (BInteger)iv);
	...
	public static void registerProcFunc(ISymbolTable symbolTable)
		...
		s = new FFaplPreProcFuncSymbol("AESEncrypt", 
                null,
                new FFaplInteger(),
                ISymbol.FUNCTION);
		s.setProcFunc(new AESEncrypt());
