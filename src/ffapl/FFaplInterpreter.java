  ...
  */
  public void run() {
    try {
      ...
      _logger.log(ILevel.ERROR,
                  CompilerMessage.getError((ICompilerError) ffe, _programName),
                  ffe.errorLine(),
                  ffe.errorColumn());
    } catch(Exception general) {
      Object[] arguments = {FFaplException.getCustomStackTrace(general)};
      _logger.log(ILevel.ERROR,
                  (new FFaplException(arguments, ICompilerError.INTERNAL)).getErrorMessage());
      throw general;
    }
  }
...
Token t1;
  ...
  FFaplNodeChoice t3;
  int pos = 0;
  int amount = 4; // Amount of choices
...
Token t1;
  ...
  FFaplNodeChoice t3;
  int pos = 0;
  int amount = 3; // Amount of choices
...
Token t1;
  ...
  ASTRandom t4;
  ASTPolynomial t5;
  int amount = 7; // Amount of choices
  FFaplNodeType t6;
  ASTECPoint t7;
  ASTECPAI t8;
  ASTECRandom t9;
...
t4.addNode(t7);
        t2 = new FFaplNodeChoice(t4, 0, amount); // adds Sequence to Choice
...
FFaplNodeChoice t1;
  ...
  //ASTExpr t7;
  FFaplNodeType t8;
  int amount = 1; // Amount of choices
