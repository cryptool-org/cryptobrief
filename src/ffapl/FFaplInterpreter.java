/* Generated By:JavaCC: Do not edit this line. FFaplInterpreter.java */
package ffapl;

import ffapl.ast.FFaplASTreeConstants;
import ffapl.ast.nodes.*;
import ffapl.exception.CompilerMessage;
import ffapl.exception.FFaplException;
import ffapl.java.exception.FFaplAlgebraicException;
import ffapl.java.interfaces.ILevel;
import ffapl.java.logging.FFaplLogger;
import ffapl.lib.FFaplSymbolTable;
import ffapl.lib.interfaces.ICompilerError;
import ffapl.types.*;
import ffapl.visitor.FFaplJavaInterpreterVisitor;
import ffapl.visitor.FFaplSymbolTypeCheckingVisitor;
...
/* Operations */
 ...
 FFaplNodeSequence t7;
  ...
  FFaplNodeSequence t5;
    ...
    {if (true) return new ASTCondOrExpr(FFT_CONDOREXPR, t1, t4);}
    throw new Error("Missing return statement in function");
  }
  ...
  FFaplNodeToken t5, t6, t7;
    ...
    {if (true) return new ASTECAssignment(FFT_ECASSIGNMENT, t5, t6, t7);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ASTECBaseField ECBaseField() throws ParseException, FFaplException {
    ...
    t1 = jj_consume_token(BRACE_RIGHT);
        ...
        {if (true) return new ASTECBaseField(FFT_ECBASEFIELD,t2,t3,t4);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ASTSameAs SameAs() throws ParseException, FFaplException {
    ...
    t1 = jj_consume_token(BRACE_RIGHT);
        ...
        {if (true) return new ASTSameAs(FFT_SAMEAS,t2);}
    throw new Error("Missing return statement in function");
  }
  ...
  ASTExpr t3, t5;
    ...
    t1 = jj_consume_token(ECRIGHT);
                t6 = new FFaplNodeToken(t1);
                {if (true) return new ASTECPoint(FFT_ECPOINT, t2, t3, t4, t5, t6);}
    throw new Error("Missing return statement in function");
  }
  ...
  FFaplNodeToken t2, t3;
    ...
    t1 = jj_consume_token(ECRIGHT);
                        {if (true) return new ASTECPAI(FFT_ECPOINT);}
    throw new Error("Missing return statement in function");
  }
  ...
  int amount = 2;
    ...
    t1 = jj_consume_token(ECRIGHT);
                        {if (true) return new ASTECRandom(FFT_ECPOINT,t3);}
    throw new Error("Missing return statement in function");
  }
  ...
  boolean isGF;
    ...
    t1 = jj_consume_token(BRACE_RIGHT);
        ...
        if (isGF == true)
        {
        {if (true) return new ASTEC(FFT_EC, t2, t3, t4, t5, t7);}
        }
        else
        {
                {if (true) return new ASTEC(FFT_EC, t2, t3, t9, t5, t7);}
        }
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_27() {
    if (jj_scan_token(ECLEFT)) return true;
  ...
  private boolean jj_3R_28() {
    if (jj_scan_token(ECLEFT)) return true;
    if (jj_scan_token(ECPAI)) return true;
    return false;
  }
  ...
  public FFaplInterpreter(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public FFaplInterpreter(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public FFaplInterpreter(java.io.Reader stream) {
  ...
  public FFaplInterpreter(FFaplInterpreterTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(FFaplInterpreterTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
