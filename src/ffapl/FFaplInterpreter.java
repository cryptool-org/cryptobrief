...
// (temporary) solution for github issue #5 "Compilation error when parsing creation expressions of type Z()[n] using a constant n"
    ...
    private boolean jj_3R_41() {
        ...
        if (jj_3R_46()) {
            if (!jj_rescan) trace_return("PowExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("PowExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_59() {
        ...
        if (jj_3R_62()) {
            if (!jj_rescan) trace_return("EqualExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("EqualExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_50() {
                ...
                if (jj_3_4()) {
                    ...
                    if (jj_3R_56()) {
                        ...
                        if (jj_3R_57()) {
                            jj_scanpos = xsp;
                            if (jj_3R_58()) {
                                if (!jj_rescan) trace_return("PrimaryExpr(LOOKAHEAD FAILED)");
                                return true;
                            }
                        }
                    }
        ...
        {
            if (!jj_rescan) trace_return("PrimaryExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_36() {
        ...
        if (jj_3R_44()) {
            jj_scanpos = xsp;
            if (jj_3R_45()) {
                if (!jj_rescan) trace_return("Expr(LOOKAHEAD FAILED)");
                return true;
            }
        }
        {
            if (!jj_rescan) trace_return("Expr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_28() {
        ...
        if (jj_scan_token(ECLEFT)) {
            if (!jj_rescan) trace_return("ECPAI(LOOKAHEAD FAILED)");
            return true;
        }
        if (jj_scan_token(ECPAI)) {
            if (!jj_rescan) trace_return("ECPAI(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("ECPAI(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_31() {
        ...
        if (jj_3R_39()) {
            jj_scanpos = xsp;
            if (jj_3R_40()) {
                if (!jj_rescan) trace_return("AddOp(LOOKAHEAD FAILED)");
                return true;
            }
        }
        {
            if (!jj_rescan) trace_return("AddOp(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_35() {
        ...
        if (jj_scan_token(IDENT)) {
            if (!jj_rescan) trace_return("IdTerm(LOOKAHEAD FAILED)");
            return true;
        }
        Token xsp;
        xsp = jj_scanpos;
        ...
        {
            if (!jj_rescan) trace_return("IdTerm(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_32() {
        ...
        if (jj_3R_41()) {
            if (!jj_rescan) trace_return("MulExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("MulExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_47() {
        ...
        if (jj_3R_51()) {
            if (!jj_rescan) trace_return("CondOrExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("CondOrExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_29() {
        ...
        if (jj_scan_token(ECLEFT)) {
            if (!jj_rescan) trace_return("ECRandom(LOOKAHEAD FAILED)");
            return true;
        }
        Token xsp;
        xsp = jj_scanpos;
        ...
        {
            if (!jj_rescan) trace_return("ECRandom(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_33() {
        ...
        if (jj_scan_token(IDENT)) {
            if (!jj_rescan) trace_return("Decl(LOOKAHEAD FAILED)");
            return true;
        }
        Token xsp;
        while (true) {
        ...
        {
            if (!jj_rescan) trace_return("Decl(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_60() {
                                ...
                                if (jj_3R_69()) {
                                    ...
                                    if (jj_3_1()) {
                                        ...
                                        if (jj_3_2()) {
                                            jj_scanpos = xsp;
                                            if (jj_3_3()) {
                                                if (!jj_rescan) trace_return("Literal(LOOKAHEAD FAILED)");
                                                return true;
                                            }
                                        }
                                    }
        ...
        {
            if (!jj_rescan) trace_return("Literal(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_70() {
        ...
        if (jj_3R_32()) {
            if (!jj_rescan) trace_return("AddExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("AddExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_51() {
        ...
        if (jj_3R_59()) {
            if (!jj_rescan) trace_return("CondAndExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("CondAndExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_72() {
        ...
        if (jj_scan_token(SQUARED_BRACE_LEFT)) {
            if (!jj_rescan) trace_return("Polynomial(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("Polynomial(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_71() {
        ...
        if (jj_scan_token(RANDOM)) {
            if (!jj_rescan) trace_return("Random(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("Random(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_30() {
        ...
        if (jj_scan_token(IDENT)) {
            if (!jj_rescan) trace_return("ProcFuncCall(LOOKAHEAD FAILED)");
            return true;
        }
        if (jj_scan_token(BRACE_LEFT)) {
            if (!jj_rescan) trace_return("ProcFuncCall(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("ProcFuncCall(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_46() {
        ...
        if (jj_3R_50()) {
            if (!jj_rescan) trace_return("UnaryExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("UnaryExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_61() {
        ...
        if (jj_scan_token(HASH_KEY)) {
            if (!jj_rescan) trace_return("ArrayLen(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("ArrayLen(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_62() {
        ...
        if (jj_3R_70()) {
            if (!jj_rescan) trace_return("RelExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("RelExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_48() {
        ...
        if (jj_scan_token(NEW)) {
            if (!jj_rescan) trace_return("CreationExpr(LOOKAHEAD FAILED)");
            return true;
        }
        {
            if (!jj_rescan) trace_return("CreationExpr(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
    ...
    private boolean jj_3R_27() {
        ...
        if (jj_scan_token(ECLEFT)) {
            if (!jj_rescan) trace_return("ECPoint(LOOKAHEAD FAILED)");
            return true;
        }
        if (jj_3R_36()) {
            if (!jj_rescan) trace_return("ECPoint(LOOKAHEAD FAILED)");
        ...
        {
            if (!jj_rescan) trace_return("ECPoint(LOOKAHEAD SUCCEEDED)");
            return false;
        }
    }
