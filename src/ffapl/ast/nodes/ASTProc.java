...
/**
 * Represents a node for <Code>Proc</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTProc extends FFaplNode {
	 ...
	 * @param node6
	 */
	public ASTProc(int id, FFaplNodeToken node1, FFaplNodeToken node2,
