...
/**
 * Represents a node for <Code>EqualExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTEqualExpr extends FFaplNode {

	public ASTRelExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTEqualExpr(int id, ASTRelExpr node1, FFaplNodeOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
