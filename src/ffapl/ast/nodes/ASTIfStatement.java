...
/**
 * Represents a node for <Code>IfStatement</Code>
 * @author Alexander Ortner
 * @version 1.0
 */
public class ASTIfStatement extends FFaplNode {
	 ...
	 * @param node4
	 */
	public ASTIfStatement(int id, FFaplNodeToken node1, ASTCondition node2,
			ASTBlock node3, FFaplNodeOpt node4) {
		super(id);
		_node1 = node1;
		_node2 = node2;
		_node3 = node3;
