...
/**
 * Represents a node for <Code>CondAndExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTCondOrExpr extends FFaplNode {

	public ASTCondAndExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTCondOrExpr(int id, ASTCondAndExpr node1, FFaplNodeListOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
