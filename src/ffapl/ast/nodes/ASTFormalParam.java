...
/**
 * Represents a node for <Code>FormalParam</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTFormalParam extends FFaplNode {

	public FFaplNodeToken _node1;
	public FFaplNodeListOpt _node2;
	public FFaplNodeToken _node3;
	public ASTParamType _node4;
	 ...
	 * @param node4
	 */
	public ASTFormalParam(int id, FFaplNodeToken node1, FFaplNodeListOpt node2,
			FFaplNodeToken node3, ASTParamType node4) {
		super(id);
		_node1 = node1;
		_node2 = node2;
		_node3 = node3;
