...
/**
 * Represents a node for <Code>ComplexAlgebraicType</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTComplexAlgebraicType extends FFaplNode {
	 ...
	 * @param node1
	 */
	public ASTComplexAlgebraicType(int id, FFaplNodeChoice node1 ) {
		super(id);
		_node1 = node1;
