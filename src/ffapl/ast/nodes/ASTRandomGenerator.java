...
/**
 * Represents a node for <Code>RandomGenerator</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTRandomGenerator extends FFaplNode {
	 ...
	 * @param node5
	 */
	public ASTRandomGenerator(int id, FFaplNodeToken node1, FFaplNodeToken node2, 
								ASTExpr node3 , FFaplNodeOpt node4, FFaplNodeToken node5) {
		super(id);
		_node1 = node1;
		_node2 = node2;
		_node3 = node3;
