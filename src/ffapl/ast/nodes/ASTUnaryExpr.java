...
/**
 * Represents a node for <Code>UnaryExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTUnaryExpr extends FFaplNode {

	public FFaplNodeOpt _node1;
	public ASTPrimaryExpr _node2;
	 ...
	 * @param node2
	 */
	public ASTUnaryExpr(int id, FFaplNodeOpt node1, ASTPrimaryExpr node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
