...
/**
 * Represents a node for <Code>Func</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTFunc extends FFaplNode {

	public FFaplNodeToken _node1;
	public FFaplNodeToken _node2;
	public FFaplNodeToken _node3;
	public FFaplNodeOpt _node4;
	public FFaplNodeToken _node5;
	public FFaplNodeToken _node6;
	public ASTParamType _node7;
	public ASTFuncBlock _node8;
	 ...
	 * @param node8
	 */
	public ASTFunc(int id, FFaplNodeToken node1, FFaplNodeToken node2,
			FFaplNodeToken node3, FFaplNodeOpt node4, FFaplNodeToken node5,
			 FFaplNodeToken node6, ASTParamType node7, ASTFuncBlock node8) {
		super(id);
		_node1 = node1;
		_node2 = node2;
		_node3 = node3;
