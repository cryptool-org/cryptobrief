...
/**
 * Represents a node for <Code>MulExpr</Code> 
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTMulExpr extends FFaplNode {

	public ASTPowExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTMulExpr(int id, ASTPowExpr node1, FFaplNodeListOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
