...
/**
 * Represents a node for <Code>ArgumentList</Code>
 * @author Alexander Ortner
 * @version 1.0
 */
public class ASTArgumentList extends FFaplNode {

	
	public ASTExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTArgumentList(int id, ASTExpr node1, FFaplNodeListOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
