...
/**
 * Represents a node for <Code>RandomGeneratorType</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTRandomGeneratorType extends FFaplNode {
	 ...
	 * @param node1
	 */
	public ASTRandomGeneratorType(int id, FFaplNodeChoice node1 ) {
		super(id);
		_node1 = node1;
