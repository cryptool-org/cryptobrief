...
/**
 * Represents a node for <Code>StatementList</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTStatementList extends FFaplNode {

	public FFaplNodeListOpt _node1;
	 ...
	 * @param node1
	 */
	public ASTStatementList(int id, FFaplNodeListOpt node1) {
		super(id);
		_node1 = node1;
