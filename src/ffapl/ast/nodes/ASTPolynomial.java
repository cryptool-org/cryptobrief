...
/**
 * Represents a node for <Code>Polynom</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTPolynomial extends FFaplNode {

	public FFaplNodeToken _node1;
	public ASTTerm _node2;
	public FFaplNodeListOpt _node3;
	 ...
	 * @param node4
	 */
	public ASTPolynomial(int id, FFaplNodeToken node1, ASTTerm node2, FFaplNodeListOpt node3,
