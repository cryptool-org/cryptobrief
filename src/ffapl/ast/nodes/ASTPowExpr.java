...
/**
 * Represents a node for <Code>PowExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTPowExpr extends FFaplNode {

	public ASTUnaryExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTPowExpr(int id, ASTUnaryExpr node1, FFaplNodeListOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
