...
/**
 * Represents a node for <Code>PsRandomGenerator</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTPsRandomGenerator extends FFaplNode {
	 ...
	 * @param node6
	 */
	public ASTPsRandomGenerator(int id, FFaplNodeToken node1, FFaplNodeToken node2,
			ASTExpr node3, FFaplNodeToken node4, ASTExpr node5, FFaplNodeToken node6) {
		super(id);
		_node1 = node1;
		_node2 = node2;
		_node3 = node3;
