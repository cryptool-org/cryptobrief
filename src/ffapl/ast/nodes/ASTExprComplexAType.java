...
/**
 * Represents a Node for <Code>ExprComplexAType</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTExprComplexAType extends FFaplNode {
	 ...
	 * @param node1
	 */
	public ASTExprComplexAType(int id, FFaplNodeChoice node1) {
		super(id);
		_node1 = node1;
