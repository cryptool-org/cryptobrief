...
/**
 * Represents a Node for <Code>ExprRandomGType</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTExprRandomGType extends FFaplNode {
	 ...
	 * @param node1
	 */
	public ASTExprRandomGType(int id, FFaplNodeChoice node1) {
		super(id);
		_node1 = node1;
