...
/**
 * Represents a node for <Code>RelExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTRelExpr extends FFaplNode {

	public ASTAddExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTRelExpr(int id, ASTAddExpr node1, FFaplNodeOpt node2) {
		super(id);
		_node1 = node1;
		_node2 = node2;
