...
/**
 * Represents a node for <Code>AddExpr</Code>
 * @author Alexander Ortner
 * @version 1.0
 *
 */
public class ASTAddExpr extends FFaplNode {

	public ASTMulExpr _node1;
	 ...
	 * @param node2
	 */
	public ASTAddExpr(int id, ASTMulExpr node1, FFaplNodeListOpt node2){
		super(id);
		_node1 = node1;
		_node2 = node2;
