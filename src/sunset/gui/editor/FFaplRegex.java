...
public class FFaplRegex {
	...
	public static void init() {
		...
		FuncProcMatcher fpMatcher = new FuncProcMatcher(regex, Font.ITALIC);
		...
		additionalMatcher.add(new RegexMatcher(TAG_PROGRAM + "|" +
											   ...
											   TAG_IF + "|" +
											   TAG_CREATION + "|" +
											   TAG_RETURN, Font.BOLD, LILA));

		additionalMatcher.add(new RegexMatcher(TAG_ARRAYLEN, LILA));

		additionalMatcher.add(new StringMatcher(BLUE));

		additionalMatcher.add(new CommentMatcher("//", null, GREEN));
		additionalMatcher.add(new CommentMatcher("/*", "*/", GREEN));
		additionalMatcher.add(new CommentMatcher("/**", "*/", BLUE));
	}
}
