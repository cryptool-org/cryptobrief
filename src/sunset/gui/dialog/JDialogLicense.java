...
public class JDialogLicense extends FFaplJDialog {
	...
	public JDialogLicense(Window frame) {
		super(frame);
		initGUI();
		initComponents();
	}
...
//				jPanel_images.add(jLabel_cc);
	...
	private void translate(){
		...
		if(lang != null && lang.toLowerCase().equals("de")){
			jEditorPane_license.setText(ILicense.License_DE);
		}else{
			jEditorPane_license.setText(ILicense.License_EN);
		}
	}
