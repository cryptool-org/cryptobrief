 ...
 *
 */
public class ActionListenerSaveAll implements ActionListener {
	 ...
	 * @param saveAllComp
	 */
	public ActionListenerSaveAll(JTabbedPaneCode tabbedPane, Vector<Component> saveComp, Vector<Component> saveAllComp) {
