...
* Manuel Langer: fixed compatibility issues with Java 9 (removal of deprecated classes like JAXB), numerous bugfixes (language syntax, internal functions and GUI) and integration of advanced search & replace function in the GUI
