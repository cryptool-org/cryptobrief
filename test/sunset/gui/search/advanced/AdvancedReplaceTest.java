...
public class AdvancedReplaceTest {
	...
	void testAllVariables() {
		try {
			_searchReplace.find("aabbcc", "%1", 0, false, true);
			...
			_searchReplace.find("abc", "a%1c", 0, false, true);
			...
			_searchReplace.find("aabbcd", "a%1b%2c", 0, false, true);
			...
			_searchReplace.find("aabccdeefgg", "%1b%2d%3f%4", 0, false, true);
	...
	void testSpecialCharacters() {
		try {
			...
			_searchReplace.find("%5abc%6", "%0abc%1", 0, false, true);
	...
	void testEscapedVariables() {
		try {			
			_searchReplace.find("aab%1bcc", "%%1%1", 0, false, true);
			...
			_searchReplace.find("aab%1bcc", "%1%%1%2", 0, false, true);
			Assert.assertEquals("aab%9bcc", _searchReplace.replaceVariables("%1%%9%2", _searchReplace.getCaptures()));
			Assert.assertEquals("aab%%9bcc", _searchReplace.replaceVariables("%1%%%9%2", _searchReplace.getCaptures()));
			
			_searchReplace.find("%1abc%1", "%%1a%1c%%1", 0, false, true);
	...
	void testUndeclaredVariables() {
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abc", "%1b%2", 0, false, true);
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abc", "a%1c%2", 0, false, true);
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abc", "a%1b%2c%3", 0, false, true);
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abc", "%0a%1c%2", 0, false, true);
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abc", "%0b%1c%2", 0, false, true);
		...
		e = Assert.assertThrows(UndeclaredVariableException.class, () -> {
			_searchReplace.find("abcdefghi", "a%1c%2e%3g%4i", 0, false, true);
	...
	void testComplexReplacements() {
		try {
			...
			String text = "Assert.assertTrue(_searchReplace.find(\"!\\\"§$%&\\\\()=\", \"!%0=\", 0, false, true));\n"
					+ "\t\t\tcheckResult(0,10,new String[] {\"\\\"§$%&\\\\()\", null, null, null, null, null, null, null, null, null});";
			String pattern = "Assert.assertTrue(%1);\n\t\t\tcheckResult(%2);";
			
			_searchReplace.find(text, pattern, 0, false, true);
			
			String newText = "_searchReplace.find(\"!\\\"§$%&\\\\()=\", \"!%0=\", 0, false, true);\n"
